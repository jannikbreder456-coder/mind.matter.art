...
6. Replace the current GitHub Pages URLs in `index.html` with the final absolute HTTPS domain.
7. Replace the GitHub Pages URL in `sitemap.xml` and `robots.txt` with the final domain.
